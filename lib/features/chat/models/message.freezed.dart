...
class _$MessageImpl implements _Message {
  ...
  @override
  String toString() {
    return 'Message(id: $id, senderId: $senderId, receiverId: $receiverId, encryptedContent: $encryptedContent, timestamp: $timestamp, mediaUrl: $mediaUrl, mediaType: $mediaType)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, senderId, receiverId,
      encryptedContent, timestamp, mediaUrl, mediaType);
...
abstract class _Message implements Message {
  const factory _Message(
      ...
      final String? mediaUrl,
      final String? mediaType}) = _$MessageImpl;
