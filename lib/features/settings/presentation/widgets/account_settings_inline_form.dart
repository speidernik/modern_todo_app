...
class AccountSettingsInlineForm extends StatefulWidget {
  const AccountSettingsInlineForm({super.key});

  @override
  State<AccountSettingsInlineForm> createState() =>
      _AccountSettingsInlineFormState();
}

class _AccountSettingsInlineFormState extends State<AccountSettingsInlineForm> {
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    TranslationService.tr(context, 'accountSettings'),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText:
                                  TranslationService.tr(context, 'newPassword'),
                              border: const OutlineInputBorder(),
                            ),
                            obscureText: true,
                            validator: (value) {
                              if (value == null || value.isEmpty) {
                                return TranslationService.tr(
                                  context,
                                  'errorUpdatingSettings',
                                  params: {'error': 'New password is required'},
                                );
                              }
                              if (value.length < 6) {
                                return TranslationService.tr(
